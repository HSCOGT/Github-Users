...
Search for GitHub users. Flutter App.
...
```text
[✓] Flutter (Channel stable, 2.5.3, on macOS 12.1 21C52 darwin-x64, locale es-GT)
    • Flutter version 2.5.3 at /Users/harrycaballeros/Developer/flutter
