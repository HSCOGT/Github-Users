...
import 'package:github_users/search/shared/providers.dart';
...
class _SearchBarState extends ConsumerState<SearchBar> {
            ...
            builder: (context, ref, child) {
              ...
              return searchHistoryState.map(
                data: (history) {
                  ...
                  return _buildPastSearchTerms(
                    history,
                    ref,
                    pushPageAndPutFirstInHistory,
                  );
                },
  ...
  Widget _buildPastSearchTerms(
    AsyncData<List<String>> history,
    WidgetRef ref,
    void Function(String searchTerm) pushPageAndPutFirstInHistory,
  ) {
    return Column(
